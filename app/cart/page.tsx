...
export default function CartPage() {
  ...
  if (!ready) {
    return <div className="container-x py-24 text-center text-ink-soft">Loading your cart…</div>;
  }
              ...
              <div className="flex flex-1 flex-col">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <button
                    ...
                    className="-m-2 p-2 text-sm font-semibold text-ink-faint hover:text-clay sm:m-0 sm:p-0"
                ...
                <div className="mt-auto flex items-center justify-between pt-3">
                  <div className="flex items-center rounded-full border border-sand">
                    <button
                      ...
                      className="px-4 py-2.5 text-lg font-semibold text-ink-soft hover:text-pine sm:px-3 sm:py-1.5"
