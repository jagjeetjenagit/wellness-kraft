...
// Native booking widget with an optional payment step.
//
...
// After payment (if any) an on-page date + time-slot picker (SlotPicker)
...
export default function BookingWidget({
  ...
  return (
    <div>
      ...
      {/* Native date + time-slot picker: books straight into our DB and
          returns a private video link — no external calendar or popup. */}
      <SlotPicker expertId={expertId} expertName={expertName} />
    </div>
  );
}
